...
@Component({
  selector: 'app-v1-rating',
  templateUrl: './v1-rating.component.html',
  styleUrls: ['./v1-rating.component.css']
})
export class V1RatingComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.api.get('api/game/chuni/v1/rating/recent', param).subscribe(
      data => {
